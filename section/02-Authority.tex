...
% -------------------------------------------------------------------------------------------------
% TODO: reenforce that auth of facts comes from two mechanisms.
%  1) parties signing bare facts, 2) transitive authority due to rule firings.
...
\subsection{Facts}
\label{s:Facts}
% TOOD: we don't have a way to generate fresh names. Hand-wave away where the identifier came from.
...
% TODO: System is transactional, spends all facts or none. Does not spend facts in sequence, but does build spend list in sequence.
