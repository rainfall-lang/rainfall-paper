...
\TODO{Cite the XA distributed transaction model}. \TODO{Cite Corda Tearoffs}. As the transaction is specified Isabelle does not enough facts to actually re-execute the transaction and check the output. However, this is possible after performing slight rearrangement of the rule code.
