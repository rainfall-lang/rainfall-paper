...
%For example, we could retrieve (input) a tuple that specifies the price of apples with the following pattern:
% \begin{code}
...
% TODO: check this is described earlier.
...
\TODO{Describe DAML model. Has authority model that allows currencies to be defined, not baked in. }
...
\TODO{Describe AdjointIO FCL model. Has baked in currency}
