...
\AMOS{
For the ``buy guitar'' example, where Alice is selling and Bob and Charlie are both buying, Alice is allowed to choose which offer to accept.
So in this example, would the Rule declaration specify @any@, and the non-deterministic choice in (EvAny) rule would be made by Alice?
}
